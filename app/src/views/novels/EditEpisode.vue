  ...
  <div class="container px-5 -py-24 mx-auto">
    ...
    <div class="flex items-center pb-5 border-b-2 border-gray-200 mb-5">
      <div class="flex items-center text-2xl">
        <span class="mr-3 ">Edit Episode</span>
      </div>
    </div>
    ...
    <form @submit.prevent="saveEpisode()">
      ...
      <button type="submit" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Edit</button>
